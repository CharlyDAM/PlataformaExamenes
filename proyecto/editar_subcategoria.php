...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM subcategorias WHERE id = $categoria_id";
...
<body>
    ...
    <br><br><br>
    <a href="categorias.php" class="boton">Volver</a>
</body>
</html>
<?php
    } else {
...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE categorias SET nombre = '$nuevo_nombre' WHERE id = $categoria_id";
