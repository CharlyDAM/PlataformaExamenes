...
if(isset($_POST['id'])) {
    ...
    if ($conn->connect_error) {
     ...
     $sql_check_questions = "SELECT COUNT(*) AS total FROM preguntas WHERE dificultad_id = $id";
     ...
     if ($total_questions > 0) {
         ...
         alert("No se puede eliminar la dificultad porque tiene preguntas asociadas.");
    ...
    $sql = "DELETE FROM dificultades WHERE id = $id";
